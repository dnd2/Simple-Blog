...
const fs = require( 'fs' ),
      ...
      Xml2obj = require( 'xml2obj-stream' ),
...
var DataHelper = ( function( undefined ) {
    ...
    data.prototype = {
        ...
        getConfig( file ) {
            ...
            let readStream  = fs.createReadStream( this.path + file ),
                parseStream = new Xml2obj.Parser( readStream ),
                res;

            var results = [];
            parseStream.each( 'configuration', function ( item ) {
